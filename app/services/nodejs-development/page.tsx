...
export const metadata = {
  title: "Hire Professional NodeJS developers | A Development Company",
  description:
    "Hire NodeJS developers for fast, efficient web solutions. Our experienced team delivers secure, scalable applications that boost growth",
};
