...
export const metadata = {
  title: "Top Angular Development Company – High-Performance Web Applications",
  description:
    "Create dynamic, responsive AngularJs apps with our Angular development services. We deliver innovative, tailored solutions that enhance functionality and user experience",
};
